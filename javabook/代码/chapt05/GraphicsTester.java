...
public class GraphicsTester extends JFrame {
    ...
    public void paint(Graphics g) {
        ...
        g.fillRect(0, 0, 370, 450);    // 绘制实心矩形
        
        Color blue = new Color(0, 100, 255);  //创建新的颜色对象
        g.setColor(blue);                   //设置当前颜色
        g.fillOval(65, 60, 240, 230);  //绘制实心椭圆
        g.fillRect(109, 290, 150, 120);//绘制实心矩形
        
        int xValues[]={109, 70, 63, 109};
        int yValues[]={290, 278, 308, 321};
        g.fillPolygon(xValues, yValues, 4);     //绘制实心多边形

        int xValues2[]={259, 305, 295, 259};
        int yValues2[]={290, 308, 332, 321};
        g.fillPolygon(xValues2, yValues2, 4);   //绘制实心多边形 
